...
app.use(
  cors({
    origin: ["http://localhost:3000", "https://netlify-thinks-aqsay-faisal34-gmail-com-is-great-72179.netlify.app", "*"],
    credentials: true,
  })
);
...
let dbURI =
  ...
  "mongodb+srv://abc:abc@cluster0.iunhwh0.mongodb.net/recipeApp?retryWrites=true&w=majority";
